...
struct Sensores {
  ...
  bool gravedad; // Indica la gravedad del accidentado 0: no se sabe, 1: puede
                 // andar por su propio pie, 2: necesita ayuda para andar.
};
...
public:
  ...
  Comportamiento(const Comportamiento &comport)
      : mapaEntidades(comport.mapaEntidades),
        ...
        mapaConPlan(comport.mapaConPlan) {}
