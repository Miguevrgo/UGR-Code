...
public:
    ...
    /**
     * @brief Constructor, if not parametres provided, it builds a BigramFreq 
     * object with "__" as the text of the bigram and 0 as the frequency 
     * @param bigram The Bigram value for the object. Input parameter
     * @param frecuency The frequency of this BigramFreq object. Input parameter
     */
