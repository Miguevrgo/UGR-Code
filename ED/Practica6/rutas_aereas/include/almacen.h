...
public:
     ...
     */
    const_iterator cbegin() const {return rutas.cbegin();};
     ...
     */
    const_iterator cend() const {return rutas.cend();};
    /**
     * @brief Constructor por defecto.
     */
    Almacen() = default;
