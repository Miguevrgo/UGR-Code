...
public class Dice {
    ...
    /**
     * This method returns the direction of the preferred move with a probability
     * proportional to the value of intelligence provided, if the preferred direction
     * is not choosen, a random directions from validMoves will be returned
     * 
     * @param preference Direction of preference
     * @param validMoves Array of valid directions
     * @param intelligence Intelligence of the moving entity
